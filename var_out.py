...
def vt_outliers(X_train_num, X_test_num):
    try:
        logger.info(f'Before Train name column: \n{X_train_num.columns} : {X_train_num.shape}')
        logger.info(f'Before Test name column: \n{X_test_num.columns} : {X_test_num.shape}')
        ...
        logger.info(f'After Train name column: \n{X_train_num.columns} : {X_train_num.shape}')
        logger.info(f'After Test name column: \n{X_test_num.columns} : {X_test_num.shape}')
